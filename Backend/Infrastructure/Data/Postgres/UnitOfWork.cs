...
public class UnitOfWork : IUnitOfWork
{
    ...
    public IAccountRepository Accounts => _accountRepository ??= new AccountRepository(_postgresContext);
    public ITransactionRepository Transactions => _transactionRepository ??= new TransactionRepository(_postgresContext);
